...
Ext.extend(GeoExt.toolTip, Ext.ToolTip, {
	...
	showFeat : function(feat){
       ...
       var count = feat.attributes.count
       //console.log(count);
       
        this.parent.setTitle(feat.attributes.count); 
        if (count > 1) {
            this.parent.setTitle("");
        }else{
            this.parent.setTitle(feat.cluster[0].attributes.name);
            GeoExt.toolTip.superclass.show.call(this.parent);
        }
        //console.log(this.parent.setTitle(feat.cluster[0].attributes.name));
		//GeoExt.toolTip.superclass.show.call(this.parent);
	},
